...
/** @brief Set overflow 33ms, prescaler 010 --> 8 */
#define TIM2_overflow_64us()  TCCR2B &= ~((1<<CS22) | (1<<CS20)); TCCR1B |= (1<<CS21);
/** @brief Set overflow 262ms, prescaler 011 --> 64 */
#define TIM2_overflow_256us() TCCR2B &= ~(1<<CS22); TCCR1B |= (1<<CS21) | (1<<CS20);
/** @brief Set overflow 1s, prescaler 100 --> 256 */
#define TIM2_overflow_4ms()    TCCR2B &= ~((1<<CS21) | (1<<CS20)); TCCR1B |= (1<<CS22);
/** @brief Set overflow 4s, prescaler // 101 --> 1024 */
#define TIM2_overflow_16ms()    TCCR2B &= ~(1<<CS21); TCCR1B |= (1<<CS22) | (1<<CS20);
/** @brief Enable overflow interrupt, 1 --> enable */
